...
int read_employees(int fd, struct db_header_t *, struct employee_t **employees_out);
...
int add_employee(struct db_header_t *db_header, struct employee_t *employees, char *add_str);
